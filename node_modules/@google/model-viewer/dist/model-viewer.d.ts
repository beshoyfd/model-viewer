...
declare type GLTFElement = Scene | Node$2 | Mesh | Material$3 | Image$3 | Texture$3 | TextureInfo$3 | Sampler$3 | PBRMetallicRoughness$3 | Accessor | Camera$1 | Animation$1 | AnimationSampler | Skin$1;
interface Asset {
    version: '2.0';
    copyright?: string;
    generator?: string;
...
declare type GLTFElementToThreeObjectMap = Map<GLTFElement, ThreeObjectSet>;
...
declare class ModelScene extends Scene$1 {
    ...
    getNDC(clientX: number, clientY: number): Vector2$1;
    /**
    ...
    hitFromPoint(ndcPosition: Vector2$1, object?: Object3D): three.Intersection<Object3D<Event>> | undefined;
    /**
     ...
     */
    positionAndNormalFromPoint(ndcPosition: Vector2$1, object?: Object3D): {
        position: Vector3$1;
        normal: Vector3$1;
        uv: Vector2$1 | null;
    } | null;
     ...
     */
    surfaceFromPoint(ndcPosition: Vector2$1, object?: Object3D): string | null;
    /**
...
declare interface Material$1 {
    ...
    readonly clearcoatTexture: TextureInfo$1 | null;
    readonly clearcoatRoughnessTexture: TextureInfo$1 | null;
    readonly clearcoatNormalTexture: TextureInfo$1 | null;
...
declare class LazyLoader {
    ...
    constructor(gltf: GLTF$1, gltfElementMap: GLTFElementToThreeObjectMap, mapKey: GLTFElement, doLazyLoad: () => Promise<{
        set: ThreeObjectSet;
        material: Material$4;
    }>);
}
...
declare class ThreeDOMElement {
    ...
    constructor(onUpdate: () => void, correlatedObjects?: CorrelatedObjects | null);
}
...
declare class Sampler extends ThreeDOMElement implements Sampler$1 {
    ...
    get rotation(): number;
    get scale(): Vector2$1;
    get offset(): Vector2$1 | null;
    setMinFilter(filter: MinFilter): void;
    setMagFilter(filter: MagFilter): void;
    setWrapS(mode: WrapMode): void;
    setWrapT(mode: WrapMode): void;
    setRotation(rotation: number | null): void;
    setScale(scale: Vector2$1 | null): void;
    setOffset(offset: Vector2$1 | null): void;
    private [$setProperty];
}
 ...
 * PBR Next properties.
 */
declare const $clearcoatTexture: unique symbol;
declare const $clearcoatRoughnessTexture: unique symbol;
declare const $clearcoatNormalTexture: unique symbol;
/**
 * Material facade implementation for Three.js materials
 */
declare class Material extends ThreeDOMElement implements Material$1 {
     ...
     * PBR Next properties.
     */
    private [$clearcoatTexture];
    private [$clearcoatRoughnessTexture];
    private [$clearcoatNormalTexture];
