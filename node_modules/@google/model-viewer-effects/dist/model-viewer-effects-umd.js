(function (global, factory) {
  ...
  function getTextureDecoding(texture, isWebGL2) {
    let decoding = "texel";
    if (texture !== null) {
      const revision = Number.parseInt(three.REVISION);
      const sRGB8Alpha8 = isWebGL2 && revision >= 133 && revision !== 135 && texture.format === three.RGBAFormat && texture.type === three.UnsignedByteType && texture.encoding === three.sRGBEncoding;
      if (!sRGB8Alpha8) {
  ...
  var Pass = class {
     ...
     */
    constructor(name = "Pass", scene = new three.Scene(), camera = dummyCamera) {
      this.name = name;
      this.renderer = null;
      this.scene = scene;
      this.camera = camera;
    ...
    set fullscreenMaterial(value) {
      ...
      if (screen !== null) {
        ...
        screen = new three.Mesh(getFullscreenTriangle(), value);
...
`;
      ...
      if (mainImageExists) {
        if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
          fragmentMainImage += effect.inputColorSpace === three.sRGBEncoding ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
        }
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    updateMaterial() {
      ...
      if (data.colorSpace === three.sRGBEncoding) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== three.UnsignedByteType) {
          ...
          this.renderTargetA.texture.encoding = three.sRGBEncoding;
          this.renderTargetB.texture.encoding = three.sRGBEncoding;
        }
      }
    }
    /**
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== three.UnsignedByteType) {
          ...
          for (const mipmap of mipmaps) {
            mipmap.texture.encoding = three.sRGBEncoding;
          }
        }
      }
    }
  ...
  var EffectComposer$1 = class {
    ...
    setRenderer(renderer) {
      ...
      if (renderer !== null) {
        ...
        if (frameBufferType === three.UnsignedByteType && renderer.outputEncoding === three.sRGBEncoding) {
          this.inputBuffer.texture.encoding = three.sRGBEncoding;
          this.outputBuffer.texture.encoding = three.sRGBEncoding;
          this.inputBuffer.dispose();
          this.outputBuffer.dispose();
        }
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      if (type === three.UnsignedByteType && renderer !== null && renderer.outputEncoding === three.sRGBEncoding) {
  ...
  var EffectShaderData = class {
    ...
    constructor() {
      ...
      this.colorSpace = three.LinearEncoding;
    }
  };
  ...
  var Effect = class extends three.EventDispatcher {
    ...
    constructor(name, fragmentShader, {
      ...
      this._inputColorSpace = three.LinearEncoding;
  ...
  var BrightnessContrastEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.SRC, brightness = 0, contrast = 0 } = {}) {
      ...
      this.inputColorSpace = three.sRGBEncoding;
    }
    /**
     * The brightness.
     *
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer.outputEncoding === three.sRGBEncoding) {
          this.renderTargetMasked.texture.encoding = three.sRGBEncoding;
        }
      }
    }
  };
  ...
  class EffectComposer extends EffectComposer$1 {
      constructor(renderer, options) {
          ...
          this[_a] = three.ACESFilmicToneMapping;
      }
      preRender() {
  ...
  class MVEffectComposer extends d$1 {
      ...
      connectedCallback() {
          ...
          this[$composer] = new EffectComposer(undefined, {
              ...
              frameBufferType: this.renderMode === 'quality' ? three.HalfFloatType : three.UnsignedByteType,
          });
      ...
      addPass(pass, requireNormals, requireDirtyRender) {
          ...
          this[$effectComposer].addPass(pass, this[$userEffectCount] + N_DEFAULT_PASSES);
